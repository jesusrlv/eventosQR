      ...
      <hr>
        <div class="row mt-1 g-4">
          <div class="col-md-6" hidden>
            <div class="card mx-auto shadow-sm card-block" style="width: 100%; height:22rem" id="transition">
              <div class="card-body align-items-center d-flex flex-column justify-content-center">
                ...
                <a href="alta_eventos.php" class="card-link" style="text-decoration:none; color:rgba(90, 46, 116, 0.9);"><i class="bi bi-plus-circle-fill"></i> Agregar evento</a>
              </div>
            </div>
          </div>
          <div class="col-md-6" hidden>
            <div class="card mx-auto shadow-sm card-block" style="width: 100%; height:22rem" id="transition">
              <div class="card-body align-items-center d-flex flex-column justify-content-center">
                ...
                <p><a href="alta_sitio.php" class="card-link" style="text-decoration:none; color:rgba(90, 46, 116, 0.9);"><i class="bi bi-plus-circle"></i> Agregar sitio</a><a href="lista_asistentes_sitios.php" class="card-link" style="text-decoration:none; color:rgba(90, 46, 116, 0.9);"><i class="bi bi-journal-text"></i> Reporte de sitio</a> </p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6" hidden>
            <div class="card mx-auto shadow-sm" style="width: 100%; height:22rem" id="transition">
              <div class="card-body align-items-center d-flex flex-column justify-content-center">
                ...
                <a href="lista_eventos.php" class="card-link" style="text-decoration:none; color:rgba(90, 46, 116, 0.9);"><i class="bi bi-list-check"></i> Listado</a>
              </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="card mx-auto shadow-sm" style="width: 100%; height:22rem" id="transition">
              <div class="card-body align-items-center d-flex flex-column justify-content-center" style=" color:#486989;">
                <h5 style="font-size:63px"><i class="bi bi-list-check"></i></h5>
                  ...
                  <p class="card-text">Listado de los asistentes que ya hicieron Check-In.</p>
            ...
            <div class="card mx-auto shadow-sm" style="width: 100%; height:22rem" id="transition">
              <div class="card-body align-items-center d-flex flex-column justify-content-center">
                <h5 style="font-size:63px"><i class="bi bi-list-columns-reverse"></i></h5>
                  ...
                  <a href="lista_catalogos.php" class="card-link" style="text-decoration:none; color:rgba(90, 46, 116, 0.9);"><i class="bi bi-list-columns-reverse"></i> Catálogos</a>
              </div>
            </div>
          </div>
        </div>
